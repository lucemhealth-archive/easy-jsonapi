...
module JSONAPI
  class Item
    class Param
      # Used to create a unique Fieldset Param
      class Field < JSONAPI::Item::Param
        
        # @param resource [String] The resource the JSONAPI::Resource::Fields belong to
        # @param res_fields [Array<JSONAPI::Resource::Field>] An array containing the only 
        ...
        # @param [String | Symbol] The new name of the resource
        ...
        # @param new_resource [Array<JSONAPI::Resource::Field>] The new fields to include for a resource
