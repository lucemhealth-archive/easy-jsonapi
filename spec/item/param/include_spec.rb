...
describe JSONAPI::Item::Param::Include do
  
  let(:i1) { JSONAPI::Item::Param::Include.new('author') }
  let(:i2) { JSONAPI::Item::Param::Include.new('comments.author') }
  let(:i3) { JSONAPI::Item::Param::Include.new(['comments', 'likes', 'users']) }
